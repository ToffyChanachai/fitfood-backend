...
class SaleRecordsAffSchema extends Schema {
  up () {
    this.create('sale_records_affs', (table) => {
      table.increments()
  ...
  down () {
    this.drop('sale_records_affs')
  }
}

module.exports = SaleRecordsAffSchema
